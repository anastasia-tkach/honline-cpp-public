...
SegmentRenderer::SegmentRenderer(const std::vector<pair<Vector3, Vector3>>& segments, const std::vector<Vector3>& colors, std::string data_path) {
	this->init(data_path);
...
SegmentRenderer::SegmentRenderer(const std::vector<pair<Vector3, Vector3>>& segments, Vector3 color, std::string data_path) {
