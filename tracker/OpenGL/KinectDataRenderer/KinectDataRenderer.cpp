...
void KinectDataRenderer::init(Camera *camera, bool undistort) {
	this->camera = camera;
	...
	///--- Create texture to colormap the point cloud
	{
		...
		const int sz = 3; GLfloat tex[3 * sz] = {/*red*/ 242.0 / 350, 46.0 / 350, 122.0 / 350, /*magenta*/ 
												         242.0 / 350, 46.0 / 350, 122.0 / 350, /*blue*/ 
			0.40, 0.0, 0.7 };
	...
	/// still not done: upload data to do inverse projection
	...
	set_uniform("undistort", undistort);
