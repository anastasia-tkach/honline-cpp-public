...
void GeometricPrimitiveRenderer::init(std::string data_path) {
	///--- Load/compile shaders
	if (!program.isLinked()) {
		QString vshader = QString::fromUtf8(data_path.c_str()) + "shaders//" + "CloudRenderer_vshader.glsl";
		QString fshader = QString::fromUtf8(data_path.c_str()) + "shaders//" + "CloudRenderer_fshader.glsl";
