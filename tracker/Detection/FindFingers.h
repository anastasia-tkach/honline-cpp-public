...
///@{ these should not be here but in the C++ file
...
class FindFingers {
public:
    FindFingers(DetectionStream *detection, Camera * camera, HandFinder * handfinder, DataFrame * current_frame);
...
//private:
	...
	Matrix_MxN crop_image(const Matrix_MxN & depth, size_t & min_row, size_t & max_row, size_t & min_column, size_t & max_column);
	void restore_original_image(size_t min_row, size_t max_row, size_t min_column, size_t max_column, 
